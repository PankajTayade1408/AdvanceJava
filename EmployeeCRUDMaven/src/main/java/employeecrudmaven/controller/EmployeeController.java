	...
	private void insertNewEmployee(HttpServletRequest request, HttpServletResponse response)
		...
		if (firstName != null && lastName != null) {
			...
			if (employeeService.validateEmail(email)) {
				request.setAttribute("messege", "Email is already Present ... Please enter unique email...");
				flag = false;
			} else {
	...
	private void updateEmployee(HttpServletRequest request, HttpServletResponse response)
		...
		if (session != null && loginId != null) {
			...
			if (firstName != null && lastName != null) {
				...
				if (!employeeService.validateEmail(email)) {
					String messege = "Enter the Valid Email Address...";
					request.setAttribute("messegeForEmail", "Enter the Valid Email Address...");
				}else {
					employee.setEmail(email);
				}
